                ...
                <div className="h-[60vh] w-[80%] flex flex-row  justify-center items-center  bg-white shadow-2xl rounded-2xl ">
                    ...
                    <div className=" w-[90vh] flex flex-col">
                        ...
                        <div className="mt-5 flex flex-row  justify-evenly items-center">
                            <a href="https://github.com/DevaHarsar" className="bg-opacity-55 rounded-full hover:animate-pulse "><img className="size-14" src={github} alt="github.svg" /></a>
                            <a href="mailto:devaharsar2004@gmail.com" className="bg-opacity-55 rounded-md hover:animate-pulse"><img className="size-14" src={email} alt="email.svg" /></a>
                            <a href="https://www.linkedin.com/in/deva-harsar-m-m-4a60bb1b6/" className=" hover:animate-pulse cursor-pointer"><img className="size-14" src={linkedin} alt="email.svg" /></a>
